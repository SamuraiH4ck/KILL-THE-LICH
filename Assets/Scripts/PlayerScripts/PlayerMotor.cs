/*
 * Ported from WiggleWizard's code
 *   -----------------------------
 ...
 *    "forward/backward" and Y in Unity is considered "up/down", this will apply
 *    when adding movement techs.
 *
 * - UPS is measured in Unity units, the idTech units DO NOT scale.
 *
 * - Default values are accurate and emulates Quake 3's feel with CPM(A) physics.
 *
 * - If a more classic Quake movement is desired manipulate CPM behaviours and aircontrol
 *
 * - This file handles both look and movement
 *
 */
